<style>
    ...
    .tool_bar{position: fixed;top: 61px;
        right: 282px;z-index: 9998;}
    .tool_bar>ul{}
    .tool_bar>ul>li{color: #fff;width: 40px;height: 40px;cursor: pointer;text-align: center;line-height: 40px;display: block;background-color: #76838e;transition: all ease 0.2s;-webkit-transition: all ease 0.2s;padding: 5px;position: relative;}
    .tool_bar>ul>li:hover{background-color: rgba(96, 96, 96, 0.8);}

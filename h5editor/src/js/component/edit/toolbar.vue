<style>
    ...
    .tool_bar>ul{}
    .tool_bar>ul>li{color: #fff;width: 30px;height: 30px;cursor: pointer;text-align: center;line-height: 40px;display: block;background-color: #76838e;transition: all ease 0.2s;-webkit-transition: all ease 0.2s;padding: 5px;position: relative;}

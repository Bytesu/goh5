...
<style>
.page-list {font-size: 0;color: #333;text-align: center;margin-bottom: 0px;margin-top: 0px;}
.page-list .pagination {font-size: 0;display: inline-block;vertical-align: middle;*display: inline;*zoom: 1;}
.page-list .pagination li {display: inline-block;vertical-align: middle;font-size: 14px;text-align: center;
	border: 1px solid #eee;margin: 0 0px;cursor: pointer;background: #fff;transition: all ease 0.3s;-webkit-transition: all ease 0.3s;-o-transition: all ease 0.3s;-moz-transition: all ease 0.3s;    font-family: "微软雅黑";    font-size: 12px;border-radius: 1px;}
.page-list .pagination li:hover {background: #007fff;color: #fff;border: 1px solid #007fff;}
.page-list .pagination li:active {background: #007fff;color: #fff;border: 1px solid #006b59;}
.page-list .pagination .active {border: 1px solid #007fff;background: #007fff;color: #fff;}

<style>
    ...
    .head_con .item > ul > li.logout:hover {
    ...
    .head_con .item.center .create_group {
        font-size: 0;
    }

    .head_con .item.center .create_group li {
        font-size: 12px;
        cursor: pointer;
    ...
    .head_con .item.center .create_group li img {
        width: 60%;
    }

    .head_con .item.center .create_group li p {
        width: 44px;
        text-align: center;
        line-height: 44px;
        height: 0;
    ...
    .head_con .item.center .create_group li .icon {
        width: 44px;
        height: 44px;
        margin: 0 auto;
        line-height: 44px;
    ...
    .head_con .item.center .create_group li .icon:hover {
        background: #484d64;
    }

    .head_con .item.center .create_group li .icon:hover p {
        height: 44px;
    }
    ...
    .btn_group li .qrcode a {
        display: block;
        width: 198px;
        height: 198px;
    }

    .btn_group li .qrcode .tips {
        color: #76838e;
        text-align: center;
        font-size: 12px;
        line-height: 12px;

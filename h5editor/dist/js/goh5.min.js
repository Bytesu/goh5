...
/***/ function(module, exports, __webpack_require__) {
	...
	var Edit = __webpack_require__(80);
...
/***/ function(module, exports, __webpack_require__) {
	...
	utils.getStyle = function (index, cssStyle, isIn) {
	    if (_typeof(store.state.currentPageData.items[index].styleObj) == 'object') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pics = __webpack_require__(6);
	...
	var mutations = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// mutations
	var mutations = (_mutations = {}, _defineProperty(_mutations, ADD_PIC, function (state, obj) {
	...
	}), _defineProperty(_mutations, DELETE_PIC, function (state, pic) {
	    state.pics.splice(state.pics.indexOf(pic), 1);
	}), _defineProperty(_mutations, TOGGLE_PIC, function (state, todo) {
...
/***/ function(module, exports) {
	...
	var DELETE_PIC = exports.DELETE_PIC = 'DELETE_PIC';
	var TOGGLE_PIC = exports.TOGGLE_PIC = 'TOGGLE_PIC';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pics = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.togglePic = exports.deletePic = exports.addPic = undefined;

	var _pics = __webpack_require__(7);
	...
	*/
	...
	var addPic = exports.addPic = makeAction(_pics.ADD_PIC); /**
	                                                          * Created by byte2 on 2016-09-02.
	                                                          */
	var deletePic = exports.deletePic = makeAction(_pics.DELETE_PIC);
	var togglePic = exports.togglePic = makeAction(_pics.TOGGLE_PIC);
...
/***/ function(module, exports) {
	...
	module.exports = {
	    txt: function txt(index, num, params) {
	        return {
	            type: 'TXT',
	    ...
	    pic: function pic(index, num, params) {
	        return {
	            type: 'IMG',
	            style: {
	                zIndex: index * 10,
	    ...
	    pics: function pics(index, num, params) {
	        return {
	            type: 'PICS',
	            style: {
	                zIndex: index * 10,
	    ...
	    graphic_circle: function graphic_circle(index, num, obj) {
	        return {
	            type: 'GRAPHIC',
	            style: {
	                zIndex: index * 10,
	    ...
	    graphic_rect: function graphic_rect(index, num, obj) {
	        return {
	            type: 'GRAPHIC',
	            style: {
	                zIndex: index * 10,
	    ...
	    video: function video(index, num, params) {
	        return {
	            type: 'VIDEO',
	            style: {
	                zIndex: index * 10,
	    ...
	    audio: function audio(index, num, params) {
	        return {
	            type: 'AUDIO',
	            style: {
	                zIndex: index * 10,
	    ...
	    plugin_carousel: function plugin_carousel(index, num, obj) {
	        return {
	            type: 'PLUGIN',
	            style: {
	                zIndex: index * 10,
...
/***/ function(module, exports) {
	...
	mutations.SETSTYLE = function (state, index, params, isIn) {
	    if (_typeof(state.currentPageData.items[index].styleObj) == 'object') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dateFilter = __webpack_require__(45);

	var directionQrcode = __webpack_require__(46);

	var Head = __webpack_require__(47);
	var Pagination = __webpack_require__(54);
	var Loading = __webpack_require__(59);
	var Alert = __webpack_require__(64);
	...
	var Head = Vue.extend({
		...
		vuex: {
			...
			actions: utils.mixin(actions, {
				openDialogElement: function openDialogElement(store) {
					store.dispatch('OPEN_DIALOG');
					store.dispatch('HIDEMATERIALLIBPIC');
				}
			})
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process && process.env && process.env.os != "Windows_NT") {
	    //production
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-4d9ed3d2/pagination.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-55a0bf0f/loading.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\t\r\n.loading_con {position: fixed;top: 0;left: 0;width: 100%;height:100%;background: #fdfbfb;z-index: 9999999;}\r\n.loading_con .loading_center{width: 50px;height: 50px;border-radius: 20px;background: transparent;}\r\n.loading_con .loading_center>div img{display: block;margin: 0 auto;width:100%;}\r\n.loading_con .loading_center>div span{display: block;margin: 15px auto 0;text-align: center;font-size: 12px;}\r\n@-webkit-keyframes loading {\r\n    from {   \r\n        -webkit-transform: rotate(0deg);\r\n    }\r\n    to {    \r\n        -webkit-transform: rotate(360deg);\r\n    }\r\n}\t\r\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-77fa6293/confirm.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Head = __webpack_require__(47);
	var Loading = __webpack_require__(59);
	var PageList = __webpack_require__(144);
	var Phone = __webpack_require__(149);
	var AttrList = __webpack_require__(170);
	var Elements = __webpack_require__(175);

	var MaterialLibMusic = __webpack_require__(182);
	var ToolBar = __webpack_require__(187);
	var SetPage = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\js\\component\\common\\dialog\\dialog.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\r\n.dialog_con .dialog_main_con{margin: 10% auto;}\r\n.dialog_con .dialog_main_con.middle{width: 850px;}\r\n.dialog_con .dialog_main_con.middle .dialog_main{height: 540px;overflow-y: auto;overflow-x: hidden}\r\n.dialog_main{padding: 15px;}\r\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dialogHeader = __webpack_require__(88);

	var _dialogHeader2 = _interopRequireDefault(_dialogHeader);

	var _dialogFooter = __webpack_require__(91);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\js\\component\\common\\dialog\\dialog-header.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-f842754a/dialog-header.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"dialog_head\">\n    <h2 >素材库</h2>\n    <!--<p>插件</p>-->\n    <!--<div class=\"vue-btn default primary\">按钮</div>&lt;!&ndash;v-component&ndash;&gt;-->\n    <!--<div class=\"upload_btn\">\n        <span>上传</span>\n        &lt;!&ndash;image/gif, image/jpeg, image/png, image/jpg&ndash;&gt;\n        <input type=\"file\" multiple=\"\" accept=\"\" style=\"display: block;width: 100%;height: 100%;position: absolute;opacity: 0;left: 0;top: 0;cursor: pointer;\">\n    </div>-->\n    <a href=\"javascript:void(0)\" class=\"dialog_link close\" @click=\"closeDialog\">×</a>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\js\\component\\common\\dialog\\dialog-footer.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-62ac6169/dialog-footer.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../../../node_modules/css-loader/index.js!./../../../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./dialog-footer.vue", function() {
				var newContent = require("!!./../../../../../../node_modules/css-loader/index.js!./../../../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./dialog-footer.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n.vue-btn.pos{    margin: 9px 15px 0 0;}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\js\\component\\common\\meta\\button.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n.vue-btn{\n    margin: 16px 0px 0;\n    padding: 0 15px;\n    -webkit-transition: all ease 0.5s;\n    border-radius: 0px;\n    display: inline-block;\n    background: #76838e;\n    color: #FFF;\n    height: 28px;\n    line-height: 28px;\n    text-align: center;\n    cursor: pointer;\n}\n.default{background: #76838e;color: #FFF;}\n.default:hover{background: #636e77;}\n.primary{background: #03A9F4;color: #FFF;}\n.primary:hover{background: #1b79f4;}\n.danger{background: #ff5151;color: #FFF;}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"vue-btn default\" :class=\"cusClass\">{{label}}</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\js\\component\\common\\dialog\\components.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-3e226186/components.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../../../node_modules/css-loader/index.js!./../../../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./components.vue", function() {
				var newContent = require("!!./../../../../../../node_modules/css-loader/index.js!./../../../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./components.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _perfectScrollbar = __webpack_require__(105);
	...
	var _pics = __webpack_require__(126);
	...
	exports.default = {
	    ...
	    ready: function ready() {
	        document.querySelector('.ps-pic') && _perfectScrollbar2.default.initialize(document.querySelector('.ps-pic'));
	    },
	    vuex: {
	        getters: {
	            list: function list(state) {
	                return state.dialog.components.list;
	            },
	            show: function show(state) {
	                return state.dialog.components.show;
	            }
	        },
	        actions: _index2.default
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialize = __webpack_require__(115);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dom = __webpack_require__(110);
	var instances = __webpack_require__(111);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cls = __webpack_require__(109);
	var dom = __webpack_require__(110);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(108);
	var cls = __webpack_require__(109);
	var defaultSettings = __webpack_require__(112);
	var dom = __webpack_require__(110);
	var EventManager = __webpack_require__(113);
	var guid = __webpack_require__(114);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cls = __webpack_require__(109);
	var instances = __webpack_require__(111);
	var updateGeometry = __webpack_require__(116);

	// Handlers
	var handlers = {
	  'click-rail': __webpack_require__(118),
	  'drag-scrollbar': __webpack_require__(119),
	  'keyboard': __webpack_require__(120),
	  'wheel': __webpack_require__(121),
	  'touch': __webpack_require__(122),
	  'selection': __webpack_require__(123)
	};
	var nativeScrollHandler = __webpack_require__(124);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dom = __webpack_require__(110);
	var instances = __webpack_require__(111);
	var updateScroll = __webpack_require__(117);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\js\\component\\common\\meta\\pics.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../../../node_modules/css-loader/index.js!./../../../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./pics.vue", function() {
				var newContent = require("!!./../../../../../../node_modules/css-loader/index.js!./../../../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./pics.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Vue.extend({
	    ...
	    computed: {
	        isSelected: function isSelected(env) {}
	    },
	    created: function created() {
	    ...
	    methods: {
	        addDomElement: function addDomElement(store) {
	            store.dispatch('CLOSE_DIALOG');
	            actions.addDomElement(arguments);
	        },
	        isSelected: function isSelected(_id) {
	            return (0, _keys2.default)(this.selects).join('|').indexOf(_id) > -1;
	        },
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"dialog_con\" v-show=\"dialog.show\" transition=\"scale\">\n    <div class=\"dialog_main_con middle\">\n        <dialog-header></dialog-header>\n        <components></components>\n        <!--<dialog-footer></dialog-footer>-->\n    </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-5362354b/pageList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ps = __webpack_require__(105);
	var store = __webpack_require__(5);
	var actions = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vue = __webpack_require__(3);
	var $ = __webpack_require__(1);
	var carousel = __webpack_require__(153);
	...
	var dragItem = __webpack_require__(163);
	var changeSize = __webpack_require__(164);
	var contextMenu = __webpack_require__(165);
	var editTextItem = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coerceNumber = __webpack_require__(158);

	var _coerceNumber2 = _interopRequireDefault(_coerceNumber);

	var _NodeList = __webpack_require__(159);
...
/***/ function(module, exports) {
	...
	!function ($) {
	    ...
	    var toggle = function toggle() {
	        ...
	        clearMenus();
	        if ($container.is('.disabled, :disabled')) return;
	        if (active) $container.removeClass("open");else $container.addClass("open");
	        $el.focus();
	        return false;
	    };
	    ...
	    Tooltip.prototype = {
	        ...
	        show: function show() {
	            ...
	            if (this.hasContent() && this.enabled) {
	                ...
	                placement = typeof opt.placement == 'function' ? opt.placement.call(this, $tip[0], this.$element[0]) : opt.placement;
	        ...
	        applyAlign: function applyAlign(align, tipPos) {
	            var $tip = this.tip(),
	                actualWidth = $tip[0].offsetWidth,
	                actualHeight = $tip[0].offsetHeight,
	                css = {};
	            switch (align) {
	                case 'left':
	                    if (tipPos.width < actualWidth) css = { left: tipPos.width / 2 };
	                    break;
	                case 'right':
	                    if (tipPos.width < actualWidth) css = { left: actualWidth - tipPos.width / 2 };
	                    break;
	                case 'top':
	                    if (tipPos.height < actualHeight) css = { top: tipPos.height / 2 };
	                    break;
	                case 'bottom':
	                    if (tipPos.height < actualHeight) css = { top: actualHeight - tipPos.height / 2 };
	                    break;
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Vue.directive('changeSize', function () {
	    ...
	    var bindEvent = function bindEvent(obj, index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(4);
	var popline = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var moveItem = function moveItem(direction) {
	    for (var i = 0; i < store.state.checkedItems.length; i++) {
	...
	var copyItem = function copyItem() {};
	...
	Vue.directive('keyboard', function () {
	    $(window).keydown(function (ev) {
	        ...
	        if (keyCode === 38) {
	            ...
	            delItem();
	            return false;
	        } else if ((event.ctrlKey || event.metaKey) && keyCode === 67) {
	            // 复制
	            console.log('copy');
	            return false;
	            ...
	            console.log('paste');
	            return false;
	        } else if ((event.ctrlKey || event.metaKey) && keyCode === 65) {
	            // 全选
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-47b1aaa6/attrList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FontFace = [{ label: '方正黑体简体', faceFamily: 'FZHei-B01S', src: 'FZHei-B01S.woff' }, { label: '方正楷体简体', faceFamily: 'FZKai-Z03S', src: 'FZKai-Z03S.woff' }, { label: '方正书宋简体', faceFamily: 'FZShuSong-Z01S', src: 'FZShuSong-Z01S.woff' }, { label: '方正仿宋简体', faceFamily: 'FZFangSong-Z02S', src: 'FZFangSong-Z02S.woff' }, { label: '思源极细体', faceFamily: 'NotoSansSC-Thin', src: 'NotoSansSC-Thin.woff2' }, { label: '思源细体', faceFamily: 'NotoSansSC-Light', src: 'NotoSansSC-Light.woff2' }, { label: '思源正常', faceFamily: 'NotoSansSC-DemiLight', src: 'NotoSansSC-DemiLight.woff2' }, { label: '思源常规', faceFamily: 'NotoSansSC-Regular', src: 'NotoSansSC-Regular.woff2' }, { label: '思源中等粗体', faceFamily: 'NotoSansSC-Medium', src: 'NotoSansSC-Medium.woff2' }, { label: '思源粗体', faceFamily: 'NotoSansSC-Bold', src: 'NotoSansSC-Bold.woff2' }, { label: '思源特粗', faceFamily: 'NotoSansSC-Black', src: 'NotoSansSC-Black.woff2' }, { label: '站酷高端黑', faceFamily: 'zcool-gdh', src: 'zcool-gdh.woff' }, { label: '站酷快乐体', faceFamily: 'HappyZcool', src: 'HappyZcool.woff' }];
	var AttrListVm = null;
	var AttrList = Vue.extend({
	    ...
	    methods: {
	        selectPage: actions.selectPage,
	        addPage: actions.addPage,
	        setStyleDirect: function setStyleDirect(ev, type, px, val) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\js\\component\\edit\\elements.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-4d47a975/elements.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./elements.vue", function() {
				var newContent = require("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./elements.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tips = __webpack_require__(179);
	...
	exports.default = {
		...
		watch: {
			'materialLibPicObj.show': function materialLibPicObjShow(val, oldVal) {
		...
		methods: {
			...
			play: function play(ev, type) {},
			stop: function stop(ev, type) {}
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\t<div class=\"dialog_con lib_con\" v-show=\"materialLibPicObj.show\" transition=\"fadmaterialLibPicObje\">\n\t\t<div class=\"dialog_bg\" @click=\"hideMaterialLibPic()\"></div>\n\t\t<div class=\"dialog_main_con all_center\">\n\t\t\t<div class=\"dialog_head\">\n\t\t\t\t<h2>素材库</h2>\n\t\t\t\t<p  >{{materialLibPicObj.msg}}</p>\n\t\t\t\t<div class=\"upload_btn\" v-tips=\"['top','一次上传最多6张']\">\n\t\t\t\t\t<span>上传</span>\n                    <!--image/gif, image/jpeg, image/png, image/jpg-->\n\t\t\t\t\t<input type=\"file\" multiple  accept=\"\" @change=\"uploader($event)\" style=\"display: block;width: 100%;height: 100%;position: absolute;opacity: 0;left: 0;top: 0;cursor: pointer;\"/>\n\t\t\t\t</div>\n\t\t\t\t<a href=\"javascript:void(0)\" class=\"dialog_link close\" @click=\"hideMaterialLibPic()\">&times;</a>\n\t\t\t</div>\n\t\t\t<div class=\"dialog_main lib_con\">\n\t\t\t\t<div class=\"lib_main ps-pic\">\n\t\t\t\t\t<div class=\"content\">\n\t\t\t\t\t\t<div class=\"lib_main_head\">\n\t\t\t\t\t\t\t<ul class=\"lib_main_head_group\">\n\t\t\t\t\t\t\t\t<li><span>管理</span></li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t<ul class=\"lib_main_head_group\" style=\"display: none;\">\n\t\t\t\t\t\t\t\t<li><span>删除</span></li>\n\t\t\t\t\t\t\t\t<li><span>退出管理</span></li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"lib_main_body\" v-if=\"materialLibPicObj.type=='IMG.PIC'||materialLibPicObj.type=='IMG.BG'\">\n\t\t\t\t\t\t\t<ul class=\"pics_con\" >\n\t\t\t\t\t\t\t\t<li v-for=\"item in list\" >\n\t\t\t\t\t\t\t\t\t<img :src=\"item.file_path\" @click=\"addPicOrBg(item.file_path,materialLibPicObj.type)\">\n\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t<m-pagination :pagination-conf=\"paginationConf\"></m-pagination>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"lib_main_body\" v-if=\"materialLibPicObj.type=='GRAPHIC'\">\n\t\t\t\t\t\t\t<ul class=\"pics_con graphic\" >\n\t\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t\t<div style=\"border:2px solid rgb(0, 188, 212);width:100px;height:100px;margin:30px auto;\" @click=\"addDomElement('GRAPHIC.RECT')\" ></div>\n\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t\t<div style=\"border:2px solid rgb(0, 188, 212);border-radius:50%;width:100px;height:100px;margin:30px auto;\" @click=\"addDomElement('GRAPHIC.CIRCLE')\"></div>\n\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"lib_main_body\" v-if=\"materialLibPicObj.type=='PLUGIN'\">\n\t\t\t\t\t\t\t<ul class=\"pics_con\" >\n\t\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t\t<div style=\"position:relative;\"  @click=\"addDomElement('PLUGIN.CAROUSEL')\">\n\t\t\t\t\t\t\t\t\t\t<img src=\"" + __webpack_require__(181) + "\" style=\"left:0;top:0;transform: none;\">\n                                        <p>轮播图</p>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t\t<div style=\"position:relative;\"  @click=\"openDialog\">\n\t\t\t\t\t\t\t\t\t\t<img src=\"" + __webpack_require__(181) + "\" style=\"left:0;top:0;transform: none;\">\n\t\t\t\t\t\t\t\t\t\t<p>轮播图</p>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n                        <div class=\"lib_main_body\" v-if=\"materialLibPicObj.type=='VIDEO'\">\n                            <ul class=\"video\">\n                                <li v-for=\"item in list\" >\n                                    <video :src=\"item.file_path\" controls >您的浏览器不支持 video 标签。</video>\n                                    <p>{{item.file_name}}</p>\n                                    <span @click.stop=\"addDomElement('VIDEO',{src:item.file_path})\" class=\"use\">使用</span>\n                                    <span >{{item.file_size | FileSize}}</span>\n                                </li>\n                            </ul>\n                        </div>\n                        <div class=\"lib_main_body\" v-if=\"materialLibPicObj.type=='AUDIO'\">\n                            <ul class=\"audio\">\n                                <li v-for=\"item in list\" >\n\t\t\t\t\t\t\t\t\t<audio :src=\"item.file_path\" controls>Your browser does not support the audio element.</audio>\n                                    <p>{{item.file_name}}</p>\n                                    <span>{{item.file_size | FileSize}}</span>\n\t\t\t\t\t\t\t\t\t<div class=\"use\" @click.stop=\"addDomElement('AUDIO',{src:item.file_path})\">使用</div>\n                                </li>\n                            </ul>\n                        </div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class=\"dialog_bottom\">\n\t\t\t\t<ul class=\"dialog_btn\">\n\t\t\t\t\t<li @click=\"hideMaterialLibPic()\">取消</li>\n\t\t\t\t\t<li @click=\"ok()\">确认</li>\n\t\t\t\t</ul>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n";

/***/ },
/* 181 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-1c468365/materialLibMusic.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-acee8b26/toolbar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)

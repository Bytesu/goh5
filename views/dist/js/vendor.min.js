...
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"0":"H5Editor"}[chunkId]||chunkId) + ".min.js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	Swiper AMD Export
	===========================*/if(true){module.exports=window.Swiper;}else if(typeof define==='function'&&define.amd){define([],function(){'use strict';return window.Swiper;});}
